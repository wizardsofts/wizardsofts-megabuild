 ...
 *
 * TODO: Replace with wizwebui Card, CardHeader, CardBody, Badge components
...
function Badge({ variant, children }: { variant: 'warning' | 'info' | 'success' | 'secondary'; children: React.ReactNode }) {
