#!/bin/bash
# NFS Client Setup Script for Server 81
# Run this on Server 81: ssh wizardsofts@10.0.0.81
# Execute as: sudo bash setup_nfs_client81.sh

set -e

echo "=== NFS Client Setup for Ollama Models (Server 81) ==="
