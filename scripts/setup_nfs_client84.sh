#!/bin/bash
# NFS Client Setup Script for Server 84
# Run this on Server 84: ssh wizardsofts@10.0.0.84
# Execute as: sudo bash setup_nfs_client84.sh

set -e

echo "=== NFS Client Setup for Ollama Models (Server 84) ==="
